...
class TvMechanic extends StatefulWidget {
  const TvMechanic({Key? key}) : super(key: key);

  @override
  _TvMechanicState createState() => _TvMechanicState();
}

class _TvMechanicState extends State<TvMechanic> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text("TV Mechanics", style: TextStyle(color: Colors.white),)),
        body: StreamBuilder(
          stream: FirebaseFirestore.instance
              .collection('Service Provider').where("profession", isEqualTo: "Tv Mechanic").snapshots(),
