...
class Masonry extends StatefulWidget {
  ...
  @override
  _MasonryState createState() => _MasonryState();
}
...
class _MasonryState extends State<Masonry> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text("Masonry", style: TextStyle(color: Colors.white),)),
        body: StreamBuilder(
          stream: FirebaseFirestore.instance
              .collection('Service Provider').where("profession", isEqualTo: "Masonry").snapshots(),
