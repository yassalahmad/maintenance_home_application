...
class FreezerMechanic extends StatefulWidget {
  const FreezerMechanic({Key? key}) : super(key: key);

  @override
  _FreezerMechanicState createState() => _FreezerMechanicState();
}

class _FreezerMechanicState extends State<FreezerMechanic> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text("Freezer Mechanics", style: TextStyle(color: Colors.white),)),
        body: StreamBuilder(
          stream: FirebaseFirestore.instance
              .collection('Service Provider').where("profession", isEqualTo: "Freezer Mechanic").snapshots(),
