...
class CarMechanic extends StatefulWidget {
  ...
  @override
  _CarMechanicState createState() => _CarMechanicState();
}
...
class _CarMechanicState extends State<CarMechanic> {
  ...
  void showRating() => showDialog(
    ...
    builder: (context) => AlertDialog(
      ...
      actions: [
        MaterialButton(
          onPressed: (){
          // final docUser =  FirebaseFirestore.instance.collection('Service Provider').doc(uid);
          //  docUser.update({
          //    'rating': myRating,
          //  });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Car Mechanics", style: TextStyle(color: Colors.white),)),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection('Service Provider').where("profession", isEqualTo: "Car Mechanic").snapshots(),
...
// Text(snapshot.data.docs[0]['profession']),
// Text(snapshot.data.docs[1]['username']),
// Text(snapshot.data.docs[1]['email']),
// Text(snapshot.data.docs[1]['profession']),
// Text(snapshot.data.docs[2]['username']),
// Text(snapshot.data.docs[2]['email']),
// Text(snapshot.data.docs[2]['profession']),
// ],
// );