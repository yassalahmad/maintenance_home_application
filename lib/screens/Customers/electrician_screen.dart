...
class ElectriciansScreen extends StatefulWidget {
  const ElectriciansScreen({Key? key}) : super(key: key);

  @override
  _ElectriciansScreenState createState() => _ElectriciansScreenState();
}
...
class _ElectriciansScreenState extends State<ElectriciansScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text("Electricians", style: TextStyle(color: Colors.white),)),
        body: StreamBuilder(
          stream: FirebaseFirestore.instance
              .collection('Service Provider').where("profession", isEqualTo: "Electrician").snapshots(),
